...
import 'package:zumda/features/login/presentation/pages/signin_page.dart';
...
import 'package:zumda/features/splash/presentation/pages/splash_page.dart';
...
class AppPages {
  static final getPages = [
    ...
    GetPage(name: AppRoutes.SINGIN, page: () => SigninPage()),
